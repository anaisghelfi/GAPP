                        ...
                        <div class="ibox-content">
                            ...
                            <p>
                            	<form method="post" action="add_deadline">
	                              <input type="text" name="ajout_deadline" value="titre"></br>
	                              <input type="text" name="ajout_deadline" value="description"></br>  
	                              <input type="date" name="ajout_deadline" value="date"></br>
	                              <input type="text" name="ajout_deadline" value="groupe"></br>
	                              <input type="submit" name="ajout_deadline" value="Valider"/>
								</form>
                            </p>
