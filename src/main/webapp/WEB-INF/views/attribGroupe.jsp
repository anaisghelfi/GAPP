	...
	<div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                <div class="col-lg-6"><!-- Mettre dans cette col les boutons vers formulaire ajouts groupes, attribution des élèves, et liste des groupes, sous-groupes avec bouton pour supprimer -->
										...
										<div style="margin-bottom:6px" class="panel panel-primary">
											<div class="panel-heading">
	                                            <h5 class="panel-title">
	                                                <a data-toggle="collapse" data-parent="#accordion" href="#<c:out value="${groupe.id}"/>"><c:out value="${groupe.nom}"/><i style='float:right; margin:5px'  type="submit" class="fa fa-trash"></i><i style='float:right;margin:5px' class="fa fa-pencil"></i></a>
	                                            </h5>
	                                        </div>
										</div>
